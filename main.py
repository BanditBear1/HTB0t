...
from tasks import stocks_tasks, trend_tasks
...
ALLOWED_ORIGINS = [
    ...
    "https://we_need_an_api_hosted _on_server",  # Stage frontend application
]
...
app.include_router(economic_data.router, prefix="/economic-data")
app.include_router(algo_viewer.router, prefix="/algo-viewer")
